...
(function() {
  var Agent, BasicAnimal, Chart, Environment, Events, Interactive, Species, ToolButton, Trait, biologicaSandratSpecies, chart1, chart2, chartTypes, chowSpecies, defaultChartTypes, env, helpers, resetAndDrawCharts, sandratSpecies, updateCharts, updatePulldowns;
  ...
  $(function() {
    var chart1PeriodId, chart2PeriodId, config, configDefaults, container, editing, geneInfo, graph1Location, startChartPeriod, updateAlleleFrequencies, validateConfig, validationError;
